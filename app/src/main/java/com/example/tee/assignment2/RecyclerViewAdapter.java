package com.example.tee.assignment2;
...
public class RecyclerViewAdapter
    ...
    private List<ColorSpace.Model> items;
    private SparseBooleanArray selectedItems;

    RecyclerViewAdapter(List<ColorSpace.Model> modelData) {
        if (modelData == null) {
    ...
    public void onBindViewHolder(ListItemViewHolder viewHolder, int position) {
        ColorSpace.Model model = items.get(position);
